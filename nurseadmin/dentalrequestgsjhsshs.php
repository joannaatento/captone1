    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/functiongsjhsshs.php?dental_id=<?php echo $dental_id; ?>">Mark as Read</a>
            <?php endif; ?>

            <a href="function/dentalrequestgsjhsshs.php?dental_id=<?php echo $dental_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
            
            <a href="viewdentalrequests.php?date_created=<?php echo $row['date_created']; ?>">
