    ...
    <li class="nav-item has-submenu">
        ...
        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
            <ul class="submenu-list list-unstyled">
                <li class="submenu-item"><a class="submenu-link" href="studentlistscollege.php">Students</a></li>
                <li class="submenu-item"><a class="submenu-link" href="employeelistscollege.php">Employees</a></li>
            </ul>
        </div>
    </li>
...
<li class="nav-item has-submenu">
    ...
    <div id="submenu-5" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
        <ul class="submenu-list list-unstyled">
            <li class="submenu-item"><a class="submenu-link active" href="medicalrequestcollege.php">College</a></li>
    ...
    <li class="nav-item has-submenu">
        ...
        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
            <ul class="submenu-list list-unstyled">
                ...
                <li class="submenu-item"><a class="submenu-link" href="medicalcollege.php">Medical</a></li>
            </ul>
        </div>
    </li>
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <?php
    $sql = "SELECT * FROM dental WHERE c_employee = 'Employee in College'";
    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/functionemployeecollege.php?dental_id=<?php echo $dental_id; ?>">Mark as Read</a>
            <?php endif; ?>

            <a href="function/deletereqcollege.php?dental_id=<?php echo $dental_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
