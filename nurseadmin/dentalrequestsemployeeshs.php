	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <?php
    $sql = "SELECT * FROM dental WHERE c_employee = 'Employee in SHS'";
    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/functionemployeeshs.php?dental_id=<?php echo $dental_id; ?>">Mark as Read</a>
            <?php endif; ?>

            <a href="function/deletedentalreqshs.php?dental_id=<?php echo $dental_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
            
            <a href="viewdentalrequestemployeeshs.php?date_created=<?php echo $row['date_created']; ?>">
