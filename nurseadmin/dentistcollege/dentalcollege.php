...
?>
 <form action="function/collegerecords.php" method="POST">
   ...
   <div class="mb-3">
       <label for="inputStatus1130" class="form-label">08:00 A.M</label>
       <select class="form-select" id="inputStatus1130" name="statusden8_am">
           <option value="08:00 A.M" <?php if ($statusden8_am == 'Available') echo 'selected'; ?>>Available</option>
           <option value="Unavailable" <?php if ($statusden8_am == 'Unavailable') echo 'selected'; ?>>Unavailable</option>
       </select>
   </div>
   <div class="mb-3">
   ...
   <div class="mb-3">
       <label for="inputStatus330" class="form-label">12:00 P.M</label>
       <select class="form-select" id="inputStatus330" name="statusden12_pm">
           <option value="12:00 P.M" <?php if ($statusden12_pm == 'Available') echo 'selected'; ?>>Available</option>
           <option value="Unavailable" <?php if ($statusden12_pm == 'Unavailable') echo 'selected'; ?>>Unavailable</option>
       </select>
   </div>
   ...
   <div class="modal-footer">
       <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
       <button type="submit" name="submit_statusdentalcollegemon" class="btn btn-light">Update</button>
   </div>
</form>
</div>
</div>
...
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="updateMondayModalLabel">Tuesday Schedule</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
<?php
...
?>
 <form action="function/collegerecords.php" method="POST">
   ...
   <div class="modal-footer">
       <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
       <button type="submit" name="submit_statusdentalcollegetue" class="btn btn-light">Update</button>
   </div>
</form>
</div>
</div>
...
?>
 <form action="function/collegerecords.php" method="POST">
   ...
   <div class="modal-footer">
       <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
       <button type="submit" name="submit_statusdentalcollegewed" class="btn btn-light">Update</button>
   </div>
</form>
</div>
</div>
...
?>
 <form action="function/collegerecords.php" method="POST">
   ...
   <div class="modal-footer">
       <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
       <button type="submit" name="submit_statusdentalcollegethu" class="btn btn-light">Update</button>
   </div>
</form>
</div>
</div>
...
?>
 <form action="function/collegerecords.php" method="POST">
   ...
   <div class="modal-footer">
       <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
       <button type="submit" name="submit_statusdentalcollegefri" class="btn btn-light">Update</button>
   </div>
</form>
</div>
</div>
