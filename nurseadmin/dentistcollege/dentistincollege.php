...
<html lang="en"> 
<head>
    <title>Total Dentist Appointment Reports</title>
...
<li class="nav-item has-submenu">
    <a class="nav-link submenu-toggle active" href="dentistincollege.php" data-bs-target="#submenu-5" aria-controls="submenu-5">
        <span class="nav-icon">
...
<li class="nav-item has-submenu">
    <a class="nav-link submenu-toggle" href="dentalcollege.php" data-bs-target="#submenu-4" aria-controls="submenu-4">
        <span class="nav-icon">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-check" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M10.854 6.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 8.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
...
window.myChart = new Chart(ctx, {
    ...
    options: options,
            ...
            function printChart() {
                   ...
                   printWindow.document.write('<th style="border: 2px solid #000; padding: 8px; text-align: center; background-color: #f2f2f2;">Total Students College</th>');
                   printWindow.document.write('<th style="border: 2px solid #000; padding: 8px; text-align: center; background-color: #f2f2f2;">Total Employees College</th>');
                   printWindow.document.write('</tr>');
