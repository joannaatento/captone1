...
switch ($report_types) {
    case 'week':
        ...
        fullname, sched_time
        FROM dentalapp
        WHERE role IN ('Student in SHS', 'Student in GS/JHS') AND YEAR(date_time) = ?";
        break;
...
<table class="clinic-table" id="clinicTable">
  ...
  document.getElementById("printButton").addEventListener("click", function () {
    ...
    printWindow.document.write('<div style="text-align: center;"><b>HEALTH SERVICE UNIT - North Department</b></div>');
...
// Create the table for your content
    ...
    printWindow.document.write('tr.header { color: #f2f2f2; text-align: center; }');
