    ...
    <li class="nav-item has-submenu">
        ...
        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
            <ul class="submenu-list list-unstyled">
                <li class="submenu-item"><a class="submenu-link" href="studentlistdentistcollegeside.php">Students</a></li>
    ...
    <table>
      ...
      <tbody id="healthRecordTableBody">
        ...
        <tr>
          ...
          <td>
            <center><a href="viewemployeerecorddentistside.php?idnumber=<?php echo $row['idnumber']; ?>">
