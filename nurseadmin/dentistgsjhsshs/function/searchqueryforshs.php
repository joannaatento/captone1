...
$sql = "SELECT * FROM healthrecordformshs WHERE fullname LIKE '%$searchQuery%' OR idnumber LIKE '%$searchQuery%' OR age LIKE '%$searchQuery%' OR notified LIKE '%$searchQuery%' OR contact LIKE '%$searchQuery%'";
