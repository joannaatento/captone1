    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/foremployeecollege.php?med_id=<?php echo $med_id; ?>">Mark as Read</a>
            <?php endif; ?>

                 <a href="function/deletereqcollege.php?med_id=<?php echo $med_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
