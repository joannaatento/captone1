      ...
      <tbody id="healthRecordTableBody">
        ...
        <td><?php echo $row['healthcollege_id']; ?></td>
          ...
          <td>
            ...
            <a href="viewcollegerecord.php?healthcollege_id=<?php echo $row['healthcollege_id']; ?>">
            ...
            <a href="function/editrecordcollege.php?healthcollege_id=<?php echo $row['healthcollege_id']; ?>" onclick="return confirm('Are you sure you want to delete this record?')">       
