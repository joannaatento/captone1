...
<?php 
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                   ...
                   <form class="form-horizontal mt-4" action="function/editrecordcollege.php" method="POST" enctype="multipart/form-data">
                        <div class="form-container">
                            ...
                            <br>
                                ...
                                <div class="input_wrap">
                                    ...
                                    <input class="input-box" id="fullname" name="fullname" type="text" value="<?= $row['fullname']; ?>" >
                                </div>

                                <div class="input_wrap">
                                    <label for="fullname">ID Number</label>
                                    <input name="idnumber" class="input-box" type="text" value="<?=$row['idnumber'];?>" >
                                </div>
                            ...
                            <div class="input_wrap">
                                ...
                                <input name="address" id ="address" type="text" style="width:  553px;" value="<?=$row['address'];?>" >
                                </div>
                        ...
                        <div class="input_form">
                            ...
                            <input name="pcontact" class="input-box" type="text" id="pcontact" value="<?=$row['pcontact'];?>" >
                            </div>
  ...
  <?php endif; ?>
                            ...
                            <input name="birthday" class="input-box" id="birthday" type="date" value="<?=$row['birthday'];?>" >
                            </div>
  ...
  <?php endif; ?>
                            ...
                            <div class="input_wrap">
                                ...
                                <input name="fguardian" class="input-box" id="fguardian" type="text" value="<?=$row['fguardian'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Occupation</label>
                                <input name="occupation1" class="input-box" id="fguardian" type="text" value="<?=$row['occupation1'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Mother's Name</label>
                                <input name="mother" id="fguardian" type="text"  class="input-box" value="<?=$row['mother'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Occupation</label>
                                <input name="occupation2" class="input-box" id="fguardian" type="text" value="<?=$row['occupation2'];?>" >
                            </div>
                            ...
                            <div class="input_wrap">
                                ...
                                <input class="input-box" name="contactemer" id="contactemer" type="text" value="<?=$row['contactemer'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Contact Numbers</label>
                                <input name="contactno" class="input-box" id="con" type="text" value="<?=$row['contactno'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Relation to student/employee</label>
                                <input name="relation" class="input-box" id="con" type="text" value="<?=$row['relation'];?>" >
                            </div>
                            ...
                            <div class="input_wrap">
                                ...
                                <input class="input-box" name="referral" id="referral" type="text" value="<?=$row['referral'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Contact Numbers</label>
                                <input class="input-box" name="contactno2" id="con" type="text" value="<?=$row['contactno2'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Physician and Number to call</label>
                                <input class="input-box" name="physiciannumcall" id="physician" type="text" value="<?=$row['physiciannumcall'];?>" >
                            </div>

                            <div class="input_wrap">
                                <label for="fullname">Address of Hospital</label>
                                <input class="input-box" name="addresshospital" id="physician" type="text" value="<?=$row['addresshospital'];?>" >
                            </div>
                        ...
                        <div class="input_form grid-row-2">
                            ...
                            <input class="input-box" name="td" id="vaccine" type="text" placeholder="Write WHEN and WHERE administered" style="width: 555px;" value="<?=$row['td'];?>" >
                            </div>

                            <div class="input_wrap" style="margin-left: 65px;">
                            <label for="fullname">Measles, Mumps, Rubella (MMR) </label>
                            <input class="input-box" name="mmr" id="vaccine" type="text" placeholder="Write WHEN and WHERE administered" style="width: 555px;" value="<?=$row['mmr'];?>" >
                            </div>
                        ...
                        <div class="input_form grid-row-2">
                            ...
                            <input class="input-box" name="hepab" id="vaccine" type="text" placeholder="Write WHEN and WHERE administered" style="width: 555px;" value="<?=$row['hepab'];?>" >
                            </div>

                            <div class="input_wrap" style="margin-left: 65px;">
                            <label for="fullname">Varicella</label>
                            <input class="input-box" name="varicella" id="vaccine" type="text" placeholder="Write WHEN and WHERE administered" style="width: 555px;" value="<?=$row['varicella'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="asthma_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['asthma_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="bleedingtendency_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['asthma_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="cancer_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['cancer_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="diabetes_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['diabetes_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="heartdisorder_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['heartdisorder_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="highblood_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['highblood_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="kidneyproblem_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['kidneyproblem_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="mentaldisorder_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['mentaldisorder_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="obesity_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['obesity_relation'];?>" >
                            </div>
                        ...
                        <div class="row-container">
                            ...
                            <div class="input_wrap">
                            <input class="input-box" style="width: 400px;" name="seizuredisorder_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['seizuredisorder_relation'];?>" >
                            </div>
                        </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="stroke_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['stroke_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <div class="input_wrap">
                                <input class="input-box" style="width: 400px;" name="tb_relation" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['tb_relation'];?>" >
                            </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <input name="specialmed" type="text" style="" value="<?=$row['specialmed'];?>" >
                        </div>
                        <div class="input_wrap">
                            <label>Allergic to the ff. drugs:</label>
                            <input name="allergicdrugs" style="" type="text" value="<?=$row['allergicdrugs'];?>" >
                        </div>
                        <div class="input_wrap">
                            <label>Other relevant information</label>
                            <input name="otherrelevant" style="" type="text" value="<?=$row['otherrelevant'];?>" >
                        </div>
                        </div>
