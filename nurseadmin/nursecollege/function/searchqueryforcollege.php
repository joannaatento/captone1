...
$sql = "SELECT * FROM healthrecordformcollege WHERE fullname LIKE '%$searchQuery%' OR idnumber LIKE '%$searchQuery%' OR courseyear LIKE '%$searchQuery%' OR contactemer LIKE '%$searchQuery%' OR contactno LIKE '%$searchQuery%'";
