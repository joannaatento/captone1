              ...
              <?php
                  ...
                  ?>
                    <form action="function/collegerecords.php" method="POST">
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
                          <button type="submit" name="submit_statusmedicalcollegetue" class="btn btn-light">Update</button>
                      </div>
                  </form>
              </div>
          </div>
              ...
              <?php
                  ...
                  ?>
                    <form action="function/collegerecords.php" method="POST">
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
                          <button type="submit" name="submit_statusmedicalcollegewed" class="btn btn-light">Update</button>
                      </div>
                  </form>
              </div>
          </div>
              ...
              <?php
                  ...
                  ?>
                    <form action="function/collegerecords.php" method="POST">
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
                          <button type="submit" name="submit_statusmedicalcollegethu" class="btn btn-light">Update</button>
                      </div>
                  </form>
              </div>
          </div>
              ...
              <?php
                  ...
                  ?>
                    <form action="function/collegerecords.php" method="POST">
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-light" data-bs-dismiss="modal" >Close</button>
                          <button type="submit" name="submit_statusmedicalcollegefri" class="btn btn-light">Update</button>
                      </div>
                  </form>
              </div>
          </div>
