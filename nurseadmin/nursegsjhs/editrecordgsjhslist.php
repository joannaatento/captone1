            ...
            <br>
              ...
              <div class="input_form grid-row-3">
                ...
                <div class="input_wrap">
                  ...
                  <input name="fullname" type="text" class="input-box" value="<?=$row['fullname']; ?>"  >
                </div>

                <div class="input_wrap">
                  <label for="fullname">ID Number</label>
                  <input name="idnumber" type="text" class="input-box" value="<?=$row['idnumber'];?>"  >
                </div>

                <div class="input_wrap">
                  <label for="fullname">Personal Contact Number</label>
                  <input name="cp" type="text" class="input-box" value="<?=$row['cp'];?>" >
                </div>
...
<div class="input_wrap">
  ...
  <input name="birthday" type="text" class="input-box" value="<?=$row['birthday'];?>" >
</div>
...
<div class="input_form grid-row-1">
  <div class="input_wrap">
      ...
      <input class="input-box" name="address" id ="address" type="text" value="<?=$row['address'];?>" >
  </div>
</div>
...
<div class="input_wrap">
  ...
  <input class="input-box" name="cfather" id="contactInput_one" type="text" value="<?=$row['cfather'];?>" >
</div>
...
<div class="input_wrap">
    <label for="fullname">Contact</label>
    <input class="input-box" name="cmother" id="contactInput_two" type="text" value="<?=$row['cmother'];?>" >
</div>
...
<div class="input_wrap">
    <label for="fullname">Contact</label>
    <input id="contactInput_cguardian" class="input-box" name="cguardian" type="text"  value="<?=$row['cguardian'];?>" >
</div>
...
<div class="input_wrap">
  ...
  <input class="input-box" name="others" id="others" type="text" value="<?=$row['others'];?>" >
</div>
...
<div class="input_wrap" style="text-align: center;">
<p>Vaccination Screenshot</p>
                <div class="image_container" style="display: inline-block; text-align: center;">
                    <img src="<?php echo "/DivineClinic/upload_image/".$row['imagevac'];?>" style="display: block; margin: 0 auto;">
...
<div class="checkbox-group">
  ...
  <div class="input_wrap">
      <label for="fullname">Others</label>
      <input name="othersmedical" class="input-box" id ="othersmedical" type="text" placeholder="Other Conditions"  value="<?=$row['othersmedical'];?>" >
  </div>

<div class="input_wrap question">
...
<div class="row-container">
  ...
  <div>
    <input class="checkbox" name="heartcondition" value="no" type="radio" id="noheartcon" <?php if (isset($row['heartcondition']) && $row['heartcondition'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="noheartcon">No</label>
  </div>

  <div class="input_wrap">
    <input name="heartcon_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['heartcon_specify'];?>" >
  </div>
</div>
</div>
...
<div class="row-container">
  ...
  <div>
  <input class="checkbox" name="eyeproblem" value="yes" type="radio" id="yeseyeproblem" <?php if (isset($row['eyeproblem']) && $row['eyeproblem'] == 'yes') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="yeseyeproblem">Yes</label>
  </div>

  <div>
  <input class="checkbox" name="eyeproblem" value="no" type="radio" id="noeyeproblem" <?php if (isset($row['eyeproblem']) && $row['eyeproblem'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="noeyeproblem">No</label>
  </div>

  <div class="input_wrap">
    <input class="input-box" name="eyeprob_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['eyeprob_specify'];?>" >  
  </div>
...
<div class="row-container">
  ...
  <div>
    <input class="checkbox" name="seriousillness" value="yes" type="radio" id="yesseriousillnes" <?php if (isset($row['seriousillness']) && $row['seriousillness'] == 'yes') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="yesseriousillnes">Yes</label>
  </div>

  <div>
    <input class="checkbox" name="seriousillness" value="no" type="radio" id="noseriousillnes" <?php if (isset($row['seriousillness']) && $row['seriousillness'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="noseriousillnes">No</label>
  </div>

  <div class="input_wrap">
    <input class="input-box" name="seriousillness_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['seriousillness_specify'];?>" >
  </div>
...
<div class="row-container">
  ...
  <div>
  <input class="checkbox" name="surgeries_injuries" value="yes" type="radio" id="yesseriousinjury" <?php if (isset($row['surgeries_injuries']) && $row['surgeries_injuries'] == 'yes') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="yesseriousinjury">
    Yes</label>
  </div>

  <div>
  <input class="checkbox" name="surgeries_injuries" value="no" type="radio" id="noseriousinjury" <?php if (isset($row['surgeries_injuries']) && $row['surgeries_injuries'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="noseriousinjury">
    No</label>
  </div>

  <div class="input_wrap">
    <input class="input-box" name="surgeries_injuries_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['surgeries_injuries_specify'];?>" >
  </div>
...
<div class="row-container">
  ...
  <div>
    <input class="checkbox" name="medicationtreatment" value="no" type="radio" id="nomedicationtreatment" <?php if (isset($row['medicationtreatment']) && $row['medicationtreatment'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="nomedicationtreatment">No</label>
  </div>

  <div class="input_wrap">
    <input class="input-box" name="medicationtreatment_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['medicationtreatment_specify'];?>" >
  </div>
</div>
...
<div class="row-container">
  ...
  <div>
    <input class="checkbox" name="allergiesmed" value="yes" type="radio" id="noallergiesmed" <?php if (isset($row['allergiesmed']) && $row['allergiesmed'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="noallergiesmed">No</label>
  </div>

  <div class="input_wrap">
  <input class="input-box" name="allergiesmed_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['allergiesmed_specify'];?>" >
  </div>
</div>
...
<div class="row-container">
  <div>
    <input class="checkbox" name="allergiesfood" value="yes" type="radio" id="yesallergiesfood" <?php if (isset($row['allergiesfood']) && $row['allergiesfood'] == 'yes') echo "checked"; ?>>
  ...
  <div class="input_wrap">
    <input class="input-box" name="allergiesfood_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['allergiesfood_specify'];?>" >
  </div>
...
<div class="row-container">
  ...
  <div>
    <input class="checkbox" name="firstaid" value="no" type="radio" id="nofirstaid" <?php if (isset($row['firstaid']) && $row['firstaid'] == 'no') echo "checked"; ?>>
...
<div class="row-container">
  ...
  <div>
    <input class="checkbox" name="concerns" value="no" type="radio" id="noconcerns" <?php if (isset($row['concerns']) && $row['concerns'] == 'no') echo "checked"; ?>>
    <label class="checkbox-label" style="font-size: 14px; padding-left: 30px;" for="noconcerns">No</label>
  </div>

  <div class="input_wrap">
    <input class="input-box" name="concerns_specify" id="otherillnesss" type="text" placeholder="If YES, please specify" value="<?=$row['concerns_specify'];?>" >
  </div>
