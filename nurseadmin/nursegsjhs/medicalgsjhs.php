...
<div class="main-content">
    ...
    <a href="function/formedicalappstudentdone.php?medicalapp_id=<?php echo $row['medicalapp_id']; ?>" onclick="return confirm('Are you sure you want to delete this record?')">
