...
<a class="nav-link submenu-toggle active" href="#" data-toggle="collapse" data-target="#submenu-3" aria-expanded="false" aria-controls="submenu-3">
        ...
        <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
            <ul class="submenu-list list-unstyled">
                ...
                <li class="submenu-item"><a class="submenu-link active" href="totalmedicines.php">Total Medicine Consumed</a></li>
            </ul>
        </div>
    </li>
        ...
        switch ($report_type) {
            case 'week':
                $sql = "SELECT CONCAT(YEAR(date_created), '-', WEEK(date_created)) AS label,
                        ...
                        FROM medicine
                        WHERE role = '1' AND YEAR(date_created) = $selected_year
