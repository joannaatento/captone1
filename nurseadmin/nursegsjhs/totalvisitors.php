...
<html lang="en"> 
<head>
    <title>Total Clinic Visitors Report</title>
...
window.myChart = new Chart(ctx, {
    ...
    printWindow.document.write('<tr><td style="text-align: center; vertical-align: middle; font-size: 18px;"><b>HEALTH SERVICE UNIT - GS and JHS Department</b></td></tr>');
...
<table class="clinic-table" id="clinicTable">
            <thead>
                <tr>
                    ...
                    <th style="width: 20px">Total of Visits in the Clinic</th>
                </tr>
            </thead>
