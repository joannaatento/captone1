...
<form class="form-horizontal mt-4" method="post" action="function/shsrecords.php">
            ...
            <div class="row">
                  <div class="col-sm-4">
                      <div class="form-group">
                          <label for="medicine_name" class="col-sm-4 control-label">Medicine</label>
...
<div class="app-card-body p-4">
    ...
    <table>
        ...
        <?php
$sql = "SELECT * FROM consultationformrecord WHERE is_deleted_on_website = 0 ORDER BY date";
            ...
            <a href="function/shsrecords.php?consultform_id=<?php echo $row['consultform_id']; ?>" onclick="return confirm('Are you sure you want to delete this record?')">
...
function searchRecords() {
  ...
  xhttp.open("GET", "function/searchqueryforshsconsultaform.php?query=" + searchQuery, true);
  xhttp.send();
}
</script>
