...
<div class="main-content">
    <table class="styled-table">
        ...
        <?php
             $sql = "SELECT * FROM medicalappshs WHERE (role = 'Student in SHS' OR role = 'Employee in SHS') AND is_deleted_on_website = 0 ORDER BY done_status ASC, date_time ASC, sched_time ASC";
            $result = mysqli_query($conn, $sql);
