...
<div class="app-card-body p-4">
    ...
    <table>
        ...
        <?php
$sql = "SELECT * FROM schoolhealthasses WHERE role = '2' AND is_deleted_on_website = 0 ORDER BY date";
$result = mysqli_query($conn, $sql);
            ...
            <a href="function/shsrecords.php?schoolasses_id=<?php echo $row['schoolasses_id']; ?>" onclick="return confirm('Are you sure you want to delete this record?')">
...
function searchRecords() {
  ...
  xhttp.open("GET", "function/searchqueryforshsschoolassess.php?query=" + searchQuery, true);
  xhttp.send();
}
</script>
