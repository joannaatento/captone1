...
<html lang="en"> 
<head>
    <title>Total Clinic Visitor Report</title>
...
window.myChart = new Chart(ctx, {
    ...
    printWindow.document.write('<tr><td style="text-align: center; vertical-align: middle; font-size: 18px;"><b>HEALTH SERVICE UNIT - SHS Department</b></td></tr>');
