...
$sql = "SELECT * FROM healthrecord WHERE role = 'employee' AND (fullname LIKE '%$searchQuery%' OR idnumber LIKE '%$searchQuery%' OR leveleduc LIKE '%$searchQuery%' OR age LIKE '%$searchQuery%' OR nameperson LIKE '%$searchQuery%' OR personcp LIKE '%$searchQuery%' OR relationship LIKE '%$searchQuery%')";
