...
<?php
$sql = "SELECT * FROM physicalexaminationgsjhs";
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <?php  	
    $pe_id = $_GET['pe_id'];
    $sql = "SELECT * FROM physicalexaminationgsjhs WHERE pe_id='$pe_id'";
...
<div class="row">
  ...
  <div class="col-sm-2">
                         <div class="form-group">
                           ...
                           <input type="text" id="levelsection" name="levelsection" class="form-control" value="<?=$row['levelsection'];?>">
                         </div>
                       </div>
</div>
<br>
...
<div class="row">
  <div class="col-sm-6">
                         <div class="form-group">
                           ...
                           <input type="text" id="extremities" name="extremities" class="form-control" value="<?=$row['extremities'];?>">
                         </div>
                       </div>
                  </div>
 ...
 <div class="col-sm-6">
                  ...
                  <br>
                     <div class="row">
                       ...
                       <input type="hidden" name="pe_id" value="<?php echo $pe_id; ?>">
                    <input type="submit" name="update_physicalexamgsjhsrecord" value="Update">
                       </div>
                     </div>
                   </form>
              </div>		
