...
<?php
$sql = "SELECT * FROM physicianorderprogressgsjhs";
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
          ...
          <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <?php  	
$pop_id = $_GET['pop_id']; // Retrieving the parameter from the URL
$sql = "SELECT * FROM physicianorderprogressgsjhs WHERE pop_id ='$pop_id'";
...
<br>
                    ...
                    <input type="submit" name="update_physicianordergsjhsrecord" value="Update">
      </div>
                       </div>
                     </div>
                   </form>
