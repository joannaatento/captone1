...
<header class="app-header fixed-top">	   	            
    ...
    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
        <ul class="submenu-list list-unstyled">
            <li class="submenu-item"><a class="submenu-link" href="physicianstudent.php">Student</a></li>
            <li class="submenu-item"><a class="submenu-link" href="physicianemployee.php">Employee</a></li>
        </ul>
    </div>
</li>
    ...
    <li class="nav-item has-submenu">
        <a class="nav-link submenu-toggle active" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
            ...
            <span class="nav-link-text">Approved Consultation Appointment</span>
            <span class="submenu-arrow">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                </svg>
    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/functionforphysiciangsjhsshs.php?physician_id=<?php echo $physician_id; ?>">Mark as Read</a>
            <?php endif; ?>

            <a href="function/functionforemployeephysiciangsjhsshs.php?physician_id=<?php echo $physician_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
