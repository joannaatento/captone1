...
<a class="nav-link submenu-toggle active" href="#" data-toggle="collapse" data-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
								...
								<div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
									<ul class="submenu-list list-unstyled">
										...
										<li class="submenu-item"><a class="submenu-link active" href="addphysicianmessagecollege.php">Request Physician Scheduling</a></li>
									</ul>
								</div>
							</li>
...
<div class="row">
  ...
  <div class="col-sm-3">
    <div class="form-group">
      <label for="gradesection" class="col-sm-10 control-label" style="font-size: 16px">Course & Year</label>
      <div class="col-sm-12">
...
<?php
    ...
    if (mysqli_num_rows($result1)) {
        ...
        $statusphysician8_am = $row1['statusphysician9_am'];
...
<th colspan="4" id="selected-day-header"><span id="selected-date-display"></span></th>
  <tr>
    ...
    <td class="<?php echo ($statusphysician12_pm == 'Unavailable') ? 'unavailable' : 'available'; ?>" onclick="handleLabelClick('<?php echo $statusphysician12_pm; ?>')"><?php echo $statusphysician12_pm; ?></td>
  </tr>
</table>
