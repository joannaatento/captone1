<?php
 ...
 if ($checkResult) {
     ...
     if ($row['count'] == 0) {
         ...
         $sql = "INSERT INTO dentalappcollege (user_id, idnumber, fullname, service, phoneno, date_time, sched_time, gradecourseyear, role, created_at, is_deleted_on_website, status) 
...
} //for dental appointment college
