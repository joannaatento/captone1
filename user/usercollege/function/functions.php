<?php
    ...
    if (isset($_POST['submit_medical'])) {
        ...
        if ($checkResult) {
            ...
            if ($row['count'] == 0) {
                // No duplicate entry, proceed with the insertion
                $sql = "INSERT INTO medicalappcollege (user_id, idnumber, fullname, gradelevel, phoneno, date_time, sched_time, role, onoff, created_at, is_deleted_on_website, status) 
