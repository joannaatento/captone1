...
<html lang="en"> 
<head>
    <title>View Consultation Record</title>
        ...
        <div class="form-title">
            Consultation Records
                ...
                <div class="row">
                      ...
                      <div class="col-sm-4">
                          <div class="form-group">
                              <label for="courseyear" class="control-label">Course & Year</label>
                                  <input type="text" class="form-control" id="courseyear" name="courseyear" placeholder="Enter Grade & Section" value="<?php echo $row['courseyear']; ?>" readonly>
                          </div>
                      </div>
                      <div class="col-sm-4">
                          <div class="form-group">
                              <label for="chiefcomplaint" class="control-label">Chief Complaint/Medicine</label>
