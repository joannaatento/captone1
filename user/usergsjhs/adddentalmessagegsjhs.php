...
<head>
        ...
        .form-group textarea[readonly]:hover
    {
       ...
       .form-group input[readonly]:focus,
        ...
        /* input.form-control {
            border: 3px solid #afbdcf !important;
...
<div class="container">
    <div class="form-container" style="margin-left: 10px;">
        ...
        <p><b>Please wait for a message for approval of your dental request appointment.</p></b>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <button type="submit" name="submit_dental" class="btn btn-success">Send Dental Appointment</button>
    </div>
</div>
</form>
