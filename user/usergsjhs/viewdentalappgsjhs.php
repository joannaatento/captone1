...
<a class="nav-link submenu-toggle active" href="#" data-toggle="collapse" data-target="#submenu-3" aria-expanded="false" aria-controls="submenu-3">
        ...
        <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
				<ul class="submenu-list list-unstyled">
					...
					<li class="submenu-item"> <a class="submenu-link active" href="viewdentalappgsjhs.php">Dental Record</a>
...
<script>
        ...
        const clinicRecordsLink = document.getElementById('clinic-records-link');
        const subMenuLinks = clinicRecordsLink.querySelectorAll('.submenu-link');
        ...
        subMenuLinks.forEach(function(subMenuLink) {
            if (currentUrl.includes(subMenuLink.getAttribute('href'))) {
                // Add the "active-link" class to the "Clinic Records" parent list item
                clinicRecordsLink.classList.add('active-link');
