...
<div class="container">
    <div class="form-container">
        ...
        <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="gradelevel" class="col-sm-12 control-label">Grade & Section</label>
                                <input type="text" class="form-control" id="gradelevel" name="gradelevel" placeholder="Enter your Fullname" value="<?php echo $row['gradelevel']; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <br>
